(() => {
 ...
 function mount(){
  ...
  setState('loading');
  const adapter=document.createElement('script');adapter.src='/wojak-3d/market-response.js?v=clean21';adapter.onload=send;document.head.append(adapter);
  ...
  frame.src='/wojak-3d/viewer.html?v=clean21';wrap.append(frame);
