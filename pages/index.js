...
export default function Home({ ogImageUrl }) {
          ...
          <header className="topbar cardless wm-sticky-header" id="market">
            ...
            <div className="topbar-right-group wm-header-content">
              <div className="topbar-center">
                <div className="market-stat">BTC.D <strong id="btcDominance">Reading</strong></div>
                <div className="market-stat">Market Cap <strong id="headerMarketCap">Reading</strong></div>
                <div className="market-stat">24H Volume <strong id="headerVolume">Reading</strong></div>
              </div>
            ...
            {/* ---------- NAVEGACIÓN DE ESCRITORIO ----------
                Solo existía en móvil. En escritorio no había forma
                de saltar entre secciones: había que hacer scroll
                por toda la página. */}
            <nav className="wm-desktop-nav" aria-label="Main navigation">
              <a href="#market">Mood</a>
              ...
              {/* MOOD destacado: es el token del proyecto, no una
                  sección más. Va al final y con tratamiento
                  propio para que se lea como destino, no como
                  otro enlace de la lista. */}
  ...
  <div className="history-chart" id="historyChart">
    {/* Sin preserveAspectRatio="none": este SVG contiene TEXTO
        (las etiquetas de banda) y el estirado lo deformaba
        horizontalmente. Los backdrops decorativos sí pueden
        estirarse; este no, porque lleva contenido legible. */}
    <svg viewBox="0 0 900 260" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
