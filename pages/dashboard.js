...
export default function Dashboard({ ogImageUrl }) {
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://wojakmeter.com/dashboard" />
        ...
        <meta property="og:url" content="https://wojakmeter.com/dashboard" />
        ...
        <div className="app-shell">
          ...
          <header className="topbar cardless wm-sticky-header" id="market">
            ...
            <div className="wm-header-top">
              ...
              <a href="/" className="wm-brand" aria-label="WojakMeter home">
                <img
            ...
            <section className="rush-section" id="emotionRush" data-market-mood="neutral">
              ...
              <div className="rush-shell rush-card">
                <div className="rush-card-side">
                  ...
                  <ol className="rush-how">
                    <li><span>1</span> A number from 0 to 100 appears.</li>
                    <li><span>2</span> Tap the face that matches it.</li>
                    <li><span>3</span> Every hit makes the next one faster.</li>
                  </ol>

                  <p className="rush-lede">
                    Three lives. The live market sets the pace and the colour
                    of your run.
                  </p>
                ...
                <div className="rush-card-main">
                  ...
                  <div className="rush-card-record">
  ...
  <div className="rush-hud">
                  ...
                  <div className="rush-stage" id="rushStage">
                    ...
                    {/* Los gritos de racha van por encima del tablero, no
                        en la linea de feedback: tienen que verse sin
                        apartar la vista de la cuadricula. */}
                    <div className="rush-callout" id="rushCallout" aria-live="polite"></div>
                    ...
                    {/* El overlay de inicio se elimino: abrir el lightbox
                        arranca la partida directamente. Dos pulsaciones
